...
//import AppDomain
//
//public final class ShopSectionBuilder: SectionBuilderProtocol {
//    
//    public init() {}
//    
//    public func createShopSections(from products: ShopSectionsResponse, for buttonDataType: ButtonDataType) -> [ShopSection] {
//        
