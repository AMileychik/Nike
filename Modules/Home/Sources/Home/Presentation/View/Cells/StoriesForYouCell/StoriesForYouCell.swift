...
//}
//
//// MARK: - VStack / HStack DSL
//// AppCore or DesignSystem?
//final class VStack: UIStackView {
//    init(_ arranged: [UIView], spacing: CGFloat = 0, alignment: AlignmentType) {
//        super.init(frame: .zero)
//        axis = .vertical
...
//        ], spacing: 8, alignment: .fill)
//        
//        let smallRow = HStack([small1Stack, small2Stack], spacing: 16, alignment: .fill)
//
//        let headerRow = HStack([headerLabel, headerButton], alignment: .center)
//        
//        let content = VStack([
...
//            smallRow,
//            bottomButton
//        ], spacing: 16, alignment: .fill)
//      
//        addSubview(content)
//        content.pinToEdges(insets: .init(top: 24, left: 24, bottom: 24, right: 24))
//        
//        NSLayoutConstraint.activate([
//            largeImage.heightAnchor.constraint(equalTo: largeImage.widthAnchor),
//            small1Image.heightAnchor.constraint(equalTo: small1Image.widthAnchor),
//            small2Image.heightAnchor.constraint(equalTo: small2Image.widthAnchor),
...
//        }
//
//        largeImage.onTap { [weak self] in
//            self?.handleTap(.large) }
//        
//        small1Image.onTap { [weak self] in self?.handleTap(.small1) }
//        small2Image.onTap { [weak self] in self?.handleTap(.small2) }
//    }
