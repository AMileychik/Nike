...
//import AppInterface
//
//public final class BecauseYouLikeContainer<Item: BecauseYouLikeItemModelProtocol, Header: BecauseYouLikeHeader>: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
//    
//    // MARK: - UI
//    
//    private let headerTitleLabel = Label(type: .header)
...
//        registerCells(for: cv)
//        return cv
//    }()
//
//    private func registerCells(for collectionView: UICollectionView) {
//        collectionView.registerCell(BecauseYouLikeCollectionCell<Item>.self)
//    }
//    
//    // MARK: - Private State
//    
...
//    
//    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
//        let cell = collectionView.dequeuCell(indexPath) as BecauseYouLikeCollectionCell<Item>
//        let item = items[indexPath.item]
...
//    static let headerButtonWidth: CGFloat = 75
//    static let headerStackLeading: CGFloat = 24
//    static let headerStackTrailing: CGFloat = -20
//    
//    static let stackTop: CGFloat = 36
