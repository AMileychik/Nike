...
- `ScreenFactory` собирает экраны, передавая зависимости через инициализаторы.
- Такой подход снижает связанность, упрощает тестирование и масштабирование.

DI внедряется один раз при запуске приложения и используется для построения интерфейса.
...
**Архитектура:** MVC  
**Особенности:** карусель изображений, кастомная кнопка добавления, состояние товара (выбран / нет).
...
**Архитектура:** MVC  
**Особенности:** синхронизация с корзиной и Detail, динамическое обновление UI.
...
**Архитектура:** MVC  
**Особенности:** пересчет стоимости в реальном времени, обработка пустой корзины, избранное из корзины.
...
- Промо-карусель и секции товаров.

**Архитектура:** MVVM  
**Особенности:** вложенные collectionView, приветствие, reusability.

### Shop
- Категории: Men, Women, Kids.
- Товары и ознакомительные блоки.

**Архитектура:** MVP  
**Особенности:** логика в презентере, масштабируемость.
...
**Архитектура:** MVC  
**Особенности:** карусель фото, кастомные кнопки.

### Favorite
- Избранные товары.
- Удаление и сохранение состояния.

**Архитектура:** MVC  
**Особенности:** динамический UI, связь с корзиной и Detail.

### Bag
- Удаление по свайпу, избранное из корзины.
- Пересчёт суммы в реальном времени.

**Архитектура:** MVC  
**Особенности:** работа с пустой корзиной, подсчёт.
